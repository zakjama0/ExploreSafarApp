...
const LoginContainer = () => {
  ...
  return (
    <div className="flex flex-col justify-evenly items-center mx-5">
      <div className="bg-gradient-to-b from-[#4d55bf] via-[#00a9a6] to-[#016b47] border-2 border-darkgreen backdrop-blur shadow-xl text-white rounded-lg p-8 w-full max-w-md mx-auto">
        <form>
